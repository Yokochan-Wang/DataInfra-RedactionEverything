#!/bin/bash
# OCR (PP-StructureV3 + PP-OCRv6) on GPU6, port 28084. Twin of ocr_g1.sh.
...
export OCR_MAX_IMAGE_SIDE=2048 OCR_PORT=28084 PADDLE_PDX_MODEL_SOURCE=modelscope
export OCR_PEER_URL=http://127.0.0.1:28085
